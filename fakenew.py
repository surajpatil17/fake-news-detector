...
# -----------------------------
# Fake Search Function (Simulation)
# -----------------------------
def search_news(news):
    # Simulated search snippets (replace with API later)
    return [
        {"snippet": "NASA scientists have confirmed the presence of water on Mars"},
        {"snippet": "Water found on the surface of Mars by space researchers"}
    ]
